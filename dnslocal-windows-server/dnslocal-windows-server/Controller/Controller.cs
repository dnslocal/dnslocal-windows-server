...
namespace DNSlocal.Controller
{
    public class Controller
    {
        ...
        private const string SoftVersionUpdateURL = "https://api.github.com/repos/dnslocal/dnslocal-windows-server/releases";
        private const string ConfigVersionUpdateURL = "https://coding.net/u/banben/p/dnslocal-windows-server/git/raw/master/config/version";
        private const string PrivoxyRuleUpdateURL = "https://coding.net/u/banben/p/dnslocal-windows-server/git/raw/master/config/user-rule.txt";
        private const string DnsRuleUpdateURL = "https://coding.net/u/banben/p/dnslocal-windows-server/git/raw/master/config/rules.cfg";
        private const string DnsConfigUpdateURL = "https://coding.net/u/banben/p/dnslocal-windows-server/git/raw/master/config/options.cfg";
